<div class="row-fluid pricing-table pricing-three-column" style="margin-top: 10px; display:block; width:100%; overflow:hidden; background:white; box-shadow: 0 0 5px hsla(0, 0%, 20%, 0.3);padding-bottom:70px">
	...
	<div style="margin-top:30px;margin-left:30px;">
		<h2 style="font-size: 28px;padding-top: 30px;">Share Us Your Suggestion</h2>
	...
	<hr>
	<div style="margin-top:30px;margin-left:30px;">
		<h2 style="padding-top:10px;">Did you migrated site from Old Domain to New Domain?</h2>
		<h2 style="padding-top:10px;">OR</h2>
		<h2 style="padding-top:10px;">Did you implemented SSL certificate on Domain like HTTPS?</h2>
		<form action="" method="post">
			<input type="submit" value="Hit This Button Update Slides URLs" name= "urispchangeurl" style= "margin-top:10px; margin-right:10px; margin-left:30px; background:#31B0D5; text-decoration:none;" class="btn btn-primary btn-lg">
			<h6 style="font-size: 22px;padding-top: 10px;padding-bottom: 10px;line-height:40px"><b>Note:</b> You can also use this option after successfully imported <b>Ultimate Responsive Image Slider</b> Plugin and Uploads directory from old server to new server.</h6>
		</form>
	</div>
</div>
<?php
